...
// Ajouts dans le Gradle pour Google.android
...
/**
 * Created by vincent.meier on 16.12.2015.
 */
public class FragmentMap extends Fragment {
    ...
    public static void setUpMapIfNeeded() {
        ...
        if (mMap == null) {
            ...
            mMap = ((MapFragment) SecondActivity.fragmentManager
    ...
    public void onDestroyView() {
        ...
        if (mMap != null) {
            SecondActivity.fragmentManager.beginTransaction()
                    .remove(SecondActivity.fragmentManager.findFragmentById(R.id.location_map)).commit();
            mMap = null;
        }
    }
}