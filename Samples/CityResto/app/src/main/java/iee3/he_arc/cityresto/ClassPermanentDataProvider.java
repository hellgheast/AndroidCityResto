...
public class ClassPermanentDataProvider  extends ContentProvider{

    static final String PROVIDER_NAME = "iee3.he_arc.cityresto.provider.Profile";
    ...
    static final String DATABASE_NAME = "ProfileUser";
